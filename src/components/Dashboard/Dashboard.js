...
export default function Dashboard({togglePlay, nextSong}) {
  ...
  return (
    <div className='dashboard'>
        ...
        <button className='dashboard__button' onClick={togglePlay}><img className='dashboard__image' src={play} alt='Запуск' /></button>
